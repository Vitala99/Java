...
public class TaskOne implements Task {
    ...
    public void task() throws IOException {
        ...
        ArrayList<Student> sortstudents = new ArrayList<Student>(students);
        sortstudents.sort(Comparator.comparing(Student::getAverage).reversed());

        System.out.println("\n======Рейтинг студентів :======\n");
        int count1 = 0, count2 = 0;
        for (var p : sortstudents) {
            boolean flag1 = true, flag2 = true;
            for(var rating : p.subjects.rating){
                if(rating != 100){
                    flag1 = false;
                }
                if(rating <= 20) {
        ...
        System.out.println("Відсоток студентів, що мають відмінні оцінки = " + 100*count1/students.size() + "%");
        System.out.println("Відсоток студентів, що мають добрі оцінки = " + 100*count2/students.size() + "%");
        System.out.println("\n====================================");
    }
